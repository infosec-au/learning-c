...
int doomsdayCalculations (int doomsdayOfMonth, int doomsdayOfWeek, int startDay) {
    ...
    int doomsdayResult = 0;
      ...
      if (doomsdayOfMonth == startDay) {
        ...
        printf("dd of month : %d\n", daysTillDesiredDateAsMultipleOfSeven);
        ...
        printf("ddremaining of month : %d\n", remainingDays);
        doomsdayResult = doomsdayOfWeek + remainingDays;
        printf("ddresult of month : %d\n", doomsdayResult);
      } else if (doomsdayOfMonth > startDay) {
